import { loginServerFn } from "@/server-functions/login";
import { logoutServerFn } from "@/server-functions/logout";

export default function LoginActionPopupMessage(
  loginServerFnRes: Awaited<ReturnType<typeof loginServerFn>>,
) {
  // Success message
  if (loginServerFnRes.status === "success") {
    return (
      <div
